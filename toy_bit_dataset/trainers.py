...
def train_unsimilar_model_smile(model_A, dataloader):
    ...
    opt_pred = optim.Adam(pred_critic.parameters(), lr=1e-3)
    opt_marginal = optim.Adam(marginal_critic.parameters(), lr=1e-3)
    opt_model_B = optim.Adam(model_B.parameters(), lr=1e-4)
    opt_AB = optim.Adam(AB_critic.parameters(), lr=1e-3)
